                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          context,
                          screenTitle: "iPhone 8 Plus - One".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.iphone8PlusOneScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "iPhone 8 Plus - Two".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.iphone8PlusTwoScreen),
                        ),
                      ],
                    ),
                  ),
